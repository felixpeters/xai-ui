...
const App = () => {
  ...
  return (
      <Router>
        <header className="bg-gray-900 md:flex md:justify-between md:items-center md:px-4 md:py-3">
          <div className="flex items-center justify-between px-4 py-3 md:p-0">
            <div>
              <img src="./fpc_logo.png" className="h-12 md:h-20" alt="Felix Peters Consulting"/>
            </div>
          ...
          <nav className={`${isOpen ? 'block' : 'hidden'} px-2 pb-4 pt-2 md:flex md:p-0`}>
            <Link to="/" className="block text-lg text-white rounded px-2 py-1 hover:bg-gray-800">Home</Link>
            <Link to="/survival" className="block mt-1 text-lg text-white rounded px-2 py-1 hover:bg-gray-800 md:mt-0">Survival Analysis</Link>
          </nav>
        </header>
        <Switch>
          <Route path="/survival">
        ...
        <footer className="bg-gray-900 flex flex-col md:flex-row md:justify-between items-center px-4 py-3">
